  ...
  return new Promise((resolve) => {
    EXIF.getData(file, function () {
      ...
      img.onload = () => {
        ...
        // ขนาดจริงหลังหมุน
        const realW = rotated ? img.height : img.width;
        const realH = rotated ? img.width  : img.height;
        ...
        // วาดภาพด้วยขนาดต้นฉบับ (ก่อน rotate) → canvas จะ clip ให้เอง
        ctx.drawImage(img,
          0, 0,
          rotated ? outH : outW,   // ขนาดภาพต้นฉบับที่ scale แล้ว
          rotated ? outW : outH
        );
        ctx.restore();
